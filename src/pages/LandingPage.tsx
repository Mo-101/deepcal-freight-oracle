...
const LandingPage = () => {
  ...
  return <div className="min-h-screen bg-deepcal-background relative overflow-hidden">
      ...
      {/* Boot Screen */}
      {!isSystemBooted && <motion.div className="fixed inset-0 bg-deepcal-background/98 flex items-center justify-center z-50" exit={{
      opacity: 0
    }} transition={{
      duration: 1
    }}>
